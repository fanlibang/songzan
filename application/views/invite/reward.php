    ...
    <div class="content flex center jc">
        <div class="new-inner">
            ...
            <div class="courtesy flex justify flow">
                ...
                <div class="courtesy-item <?php if($item1 == 0) echo 'disable' ?>"" url="<?= site_url('Invite', 'site', array('type'=> 2)) ?>">
                    <div class="courtesy-nr">
                        <img src="<?= STATIC_ASSETS ?>images/new-07.png" alt="">
                    </div>
                    <div class="courtesy-bt ">英伦女士尊享礼盒</div>
                </div>
                <div class="courtesy-item special <?php if($item1 == 0) echo 'disable' ?>"" url="<?= site_url('Invite', 'mgs') ?>">
                    <div class="courtesy-nr">
