...
class SendSms {
    ...
    public function send($tels = null, $msg = null, $type = 1){
        ...
        if($type == 1){
            ...
            $mes = '【路虎中国】亲爱的车主，您已成功参与路虎推荐购活动！分享您的专属链接http://tjaguar-songzan.syswechat.com/2018/crm/ownerreferral/index.php/Invite/index?invite_code=1njcj6 给好友，与好友一起共揽胜景，共赢好礼！退订回T';
        }
