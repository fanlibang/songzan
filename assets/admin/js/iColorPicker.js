...
var imageUrl= 'http://pic.xyzs.com/op/images/color_picker.png';
function iColorShow(id,id2){
    ...
    var def=jQuery("#style_color").val();
...
iColorPicker=function(){
    jQuery("input.iColorPicker").each(function(i){
        ...
        jQuery(this).after('<a href="javascript:void(null)" id="icp_'+this.id+'" onclick="iColorShow(\''+this.id+'\',\'icp_'+this.id+'\')"><img src="'+imageUrl+'" style="border:0;margin:0 0 0 3px" align="absmiddle" ></a>')
        })
    };
